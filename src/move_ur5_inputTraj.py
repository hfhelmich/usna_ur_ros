...
def move_repeated():
    ...
    try:
        joint_states = rospy.wait_for_message("joint_states", JointState) #what is this doing? this is subscribing to the "joint_states" topic, which is a JointState datatype. who is subscribing to it?
